...
| 插件 | 說明 |
|---|---|
| BlueCrossServer | 跨服功能插件（Blue 系列跨服組件） |
| ViaVersion | 跨版本相容，允許高版本客戶端連接低版本服務端 |
| ViaBackwards | ViaVersion 擴展，允許低版本客戶端連接高版本服務端 |
| floodgate | Geyser 附屬插件，允許基岩版玩家無需 Java 帳號加入 |

### 📡 通訊協議 / API（6）

| 插件 | 說明 |
|---|---|
| ProtocolLib | 協議庫，為其他插件提供資料包攔截和修改 API |
